...
const Card: React.FC<cardProps> = ({ data }) => {
    return (
        <div className="min-h-[20rem] w-full group/main flex flex-col justify-between rounded-2xl  m-4 transition-transform duration-600 hover:-translate-y-2">
            <div className="relative overflow-hidden rounded-t-2xl flex lg:pt-[90%] md:pt-[80%] pt-[60%]">
            ...
            <div className="flex flex-col  justify-center w-full bg-[#baecf893] rounded-b-2xl">
                <span className="xl:text-2xl lg:text-xl text-center hover:text-[#1CA8CB] py-2">
                    {data.country}
                </span>
                <span className='text-center xl:text-xl lg:text-lg'> {data.countOf} Listing</span>
                <motion.button
